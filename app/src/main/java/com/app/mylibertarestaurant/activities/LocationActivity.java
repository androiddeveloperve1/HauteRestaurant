...
import com.app.mylibertarestaurant.itnerfaces.OnAddressListener;
...
import com.app.mylibertarestaurant.utils.GoogleApiUtils;
...
public class LocationActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            getFusedLocationProviderClient(LocationActivity.this).removeLocationUpdates(locationCallback);
        }
    };
            ...
            public void onResult(LocationSettingsResult result) {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            status.startResolutionForResult(LocationActivity.this, LocationTag);
